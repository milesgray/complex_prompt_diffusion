...
from cpd.util import exists, default, ismap, isimage
from cpd.util import mean_flat, count_params, instantiate_from_config
from cpd.models.autoencoder import DiagonalGaussianDistribution
from cpd.models.autoencoder import VQModelInterface, IdentityFirstStage, AutoencoderKL
from cpd.models.ema import LitEma
...
class DDPM(nn.Module):
    ...
    def register_schedule(self, given_betas=None, beta_schedule="linear", timesteps=1000,
        ...
        self.register_buffer('posterior_mean_coef2', to_torch(
            (1. - alphas_cumprod_prev) * np.sqrt(alphas.numpy()) / (1. - alphas_cumprod.numpy())))
    ...
    def p_sample(self, x, t, clip_denoised=True, repeat_noise=False):
        ...
        noise = torch.randn(x.shape, device=device) #noise_like(x.shape, device, repeat_noise)
        # no noise when t == 0
...
class LatentDiffusion(DDPM):
    ...
    def p_sample(self, x, c, t, clip_denoised=False, repeat_noise=False,
        ...
        noise = torch.randn(x.shape, device=self.device) * temperature
        if noise_dropout > 0.:
